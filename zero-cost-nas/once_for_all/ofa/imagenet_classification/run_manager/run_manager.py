...
from once_for_all.ofa.utils import (
    get_net_info,
...
from once_for_all.ofa.utils import MyRandomResizedCrop
...
class RunManager:
    ...
    def reset_running_statistics(
        ...
        from once_for_all.ofa.imagenet_classification.elastic_nn.utils import set_running_statistics
