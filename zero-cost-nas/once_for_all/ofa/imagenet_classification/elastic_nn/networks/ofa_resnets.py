...
from once_for_all.ofa.imagenet_classification.elastic_nn.modules.dynamic_layers import (
    DynamicConvLayer,
    DynamicLinearLayer,
)
from once_for_all.ofa.imagenet_classification.elastic_nn.modules.dynamic_layers import (
...
from once_for_all.ofa.utils.layers import IdentityLayer, ResidualBlock
from once_for_all.ofa.imagenet_classification.networks import ResNets
from once_for_all.ofa.utils import make_divisible, val2list, MyNetwork
