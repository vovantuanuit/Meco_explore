...
from once_for_all.ofa.utils.layers import ResNetBottleneckBlock, ResidualBlock
from once_for_all.ofa.utils import make_divisible, MyNetwork, MyGlobalAvgPool2d
