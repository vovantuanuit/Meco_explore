...
for i in range(1000):
    ...
    # infor_mecos['meco_layers'] = meco_layers
    ...
    infor_api['net_setting'] = setting
    infor_api['test-accuracy'] = top1
    infor_api['test-accuracy_top5'] = top5
    Mobile_OFA_benchmark[i] = infor_api
...
with open(path_save_json_api, "w") as file1:  # Open file in binary write mode
    json.dump(Mobile_OFA_benchmark, file1)
